...
echo "Premier test"
gcc -Wall -Wextra -Werror -c mainmotrandom.c
gcc -Wall -Wextra -Werror -c hashFunctions.c
gcc -Wall -Wextra -Werror -c kvInitialization.c 
gcc -Wall -Wextra -Werror -c commonFunctions.c
gcc -Wall -Wextra -Werror -c kv.c 
gcc -Wall -Wextra -Werror -c slotAllocations.c 
gcc -o main *.o

#gcc -Wall -Wextra -Werror -o main mainmotrandom.c hashFunctions.c kvInitialization.c commonFunctions.c kv.c slotAllocations.c 
...
echo "Second test"
gcc -Wall -Wextra -Werror -o main mainzero.c hashFunctions.c kv.c slotAllocations.c 
# test les temps des différents méthodes de hache
...
echo "Troisieme test"
gcc -Wall -Wextra -Werror -o main mainrandom.c hashFunctions.c kv.c slotAllocations.c 
# test les temps des différents méthodes de hache
...
echo "Quatrieme test"
gcc -Wall -Wextra -Werror -o main mainint.c  hashFunctions.c kv.c slotAllocations.c 
# test les temps des différents méthodes de hache
